...
4. Generate nightly recommendations markdown (see `recommendations.md`) — an enhanced version is also available from [Microsoft/sbi](https://github.com/Microsoft/sbi/blob/main/docs/daily_recommendations.md)
