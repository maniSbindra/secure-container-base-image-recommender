...
_Generated: 2026-02-01T04:33:12.510171Z from azure_linux_images.db. Criteria: lowest critical -> high -> total vulnerabilities -> size. Top 10 per language._
...
| Rank | Image | Version | Crit | High | Total | Size | Digest |
|------|-------|---------|------|------|-------|------|--------|
| 1 | `mcr.microsoft.com/openjdk/jdk:21-distroless` | 21.0.10 | 0 | 0 | 0 | 351.0 MB | `sha256:c570b2344669` |
| 2 | `mcr.microsoft.com/openjdk/jdk:21-azurelinux` | 21.0.10 | 0 | 0 | 0 | 482.0 MB | `sha256:17ea4f4779f3` |
| 3 | `mcr.microsoft.com/openjdk/jdk:21-ubuntu` | 21.0.10 | 0 | 0 | 67 | 476.0 MB | `sha256:ba26a8a676a4` |
...
| Rank | Image | Version | Crit | High | Total | Size | Digest |
|------|-------|---------|------|------|-------|------|--------|
| 1 | `mcr.microsoft.com/openjdk/jdk:21-ubuntu` | 5.34.0 | 0 | 0 | 67 | 476.0 MB | `sha256:ba26a8a676a4` |
| 2 | `docker.io/library/python:3-slim` | 5.40.1 | 3 | 5 | 103 | 119.0 MB | `sha256:9b81fe9acff7` |
| 3 | `mcr.microsoft.com/dotnet/runtime:8.0` | 5.36.0 | 3 | 5 | 103 | 193.0 MB | `sha256:d63a6fd96a4d` |
| 4 | `mcr.microsoft.com/dotnet/aspnet:8.0` | 5.36.0 | 3 | 5 | 103 | 218.0 MB | `sha256:4b8f0b085348` |
| 5 | `docker.io/library/python:3.12-slim` | 5.40.1 | 3 | 5 | 104 | 119.0 MB | `sha256:5e2dbd4bbdd9` |
...
| 7 | `mcr.microsoft.com/openjdk/jdk:21-azurelinux` | 3.12.9 | 0 | 0 | 0 | 482.0 MB | `sha256:17ea4f4779f3` |
